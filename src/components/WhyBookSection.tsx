        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-hotel-darkGray mb-2">
                {feature.title}
              </h3>
              <p className="text-hotel-lightGray text-sm">
                {feature.description}
              </p>
            </div>
          ))}
